...
dotfilesrepo="https://github.com/quentolosse/dotfiles.git"
progsfile="https://raw.githubusercontent.com/quentolosse/dotfiles/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Quentolosse's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Quentolosse" 10 60
...
echo "Defaults editor=/usr/bin/nano" >/etc/sudoers.d/02-larbs-visudo-editor
