...
static const char *fonts[]          = { "mono:pixelsize=16:antialias=true:autohint=true", "JetBrainsMono Nerd Font Mono:style:large:size=32" };
...
static char col_white[]       = "#d8dee9";
static char col_gray2[]       = "#3b4252"; // unfocused window border
static char col_gray3[]       = "#606672";
static char col_gray4[]       = "#6d8dad";
static char col_blue[]        = "#81a1c1";  // focused window border
static char col_green[]       = "#50FA7B";  // layout indicator
static char col_red[]         = "#d57780";
static char col_orange[]      = "#caaa6a";
static char col_yellow[]      = "#ebcb8b";
static char col_pink[]        = "#e39a83";
static char col_borderbar[]   = "#2a303c"; // inner border
...
//	{ MODKEY|ShiftMask,             XK_equal,  setgaps,        {.i = 0  } },
	...
	{ MODKEY,	                XK_f,      spawn,	   {.v = (const char*[]){ "rofi", "-show"} } },
